...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Subject header toggle functionality (This is now handled by the inline onclick in createSubjectElement)
    ...
    // Lesson and exercise click handlers (These are now handled by the inline onclick in createSubjectElement)
