    ...
    'common-core': [
            {
                ...
                icon: '📝',
                lessons: [
                    { title: 'النصوص الأدبية', downloadNumber: '01' },
                    { title: 'علم البلاغة', downloadNumber: '02' },
                    { title: 'القواعد النحوية', downloadNumber: '03' },
                    { title: 'التعبير والإنشاء', downloadNumber: '04' }
                ],
                exercises: [
